...
class ActionButton<T> extends StatefulWidget {
  ...
  const ActionButton({
    ...
    this.radius,
    this.buttonColor, this.trailingIcon,
    this.padding,this.trailingIconSize,this.trailingIconColor
  }) : super(key: key);
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(
                _expanded ? widget.radius ?? size.s12 : 100),
            boxShadow: const [
              BoxShadow(
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    if(widget.trailingIcon!=null)
                      Icon(
                        widget.trailingIcon,
                        color: widget.trailingIconColor??clr.shadeWhiteColor2,
