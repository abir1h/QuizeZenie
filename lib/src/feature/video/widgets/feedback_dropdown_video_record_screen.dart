...
import '../../../common/widgets/popup_widget.dart';

class FeedBackDropDownVideoRecordScreen<T> extends StatefulWidget {
  final Future<List<T>> Function() onLoadData;
  final String Function(T item) onGenerateTitle;
  final void Function(T item) onSelected;
  final String hintText;
  final String? prefix;
  const FeedBackDropDownVideoRecordScreen({
    super.key,
  ...
  @override
  State<FeedBackDropDownVideoRecordScreen<T>> createState() =>
      _FeedBackDropDownVideoRecordScreenState<T>();
}

class _FeedBackDropDownVideoRecordScreenState<T> extends State<FeedBackDropDownVideoRecordScreen<T>>
    with AppTheme {
  T? _selectedItem;
